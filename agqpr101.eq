...
define file alt_sfsdistance = access sfsdistance, set
sfsdistance:company_id        = agqgeneral:company_id,
sfsdistance:state             = agqgeneral:state,
sfsdistance:line_of_business  = agqgeneral:line_of_business,
sfsdistance:distance_to_shore = alt_agqlocation:distance_to_shore, generic
...
" BUILDING:"/COLUMN=30 
agqgeneral:BUILD_NO/MASK="ZZZ9"/NEWLINE=2/column=43
...
agqgeneral:loss_years/column=50

"NO UNITS:"/column=65
agqgeneral:no_units/column=84/newline

"TERRITORY FACTOR:"/column=1
agqgeneral:rating_territory_factor/column=21

"SPECIAL EXPOSURE:"/column=30
agqgeneral:special_exposure_factor/column=50
 
"NO STORIES:"/column=65
agqgeneral:stories/column=84/newline
...
"DISTANCE TO SHORE:"/column=1
alt_agqlocation:distance_to_shore/column=21
" - "
alt_sfsdistance:description/newline=2
...
"NO POOLS:"/column=46
agqgeneral:no_pools/mask="ZZZZ"/align=agqgeneral:mechanical_limit
agqgeneral:pool_premium/mask="ZZ,ZZZ.99-"/align=agqgeneral:mechanical_premium/newline

"LIABILITY FLAT CHARGE:"/column=1
agqgeneral:liability_charge/mask="ZZ,ZZZ.99-"/align=alt_agqmaster:off_premises_premium

"WINDSTORM LOSS EXCL:"/column=46
switch(agqgeneral:windstorm_exclusion)
  case 1  : "Y"/align=agqgeneral:mechanical_limit/newline
  default : "N"

"RESTAURANT:"/column=1
agqgeneral:receipts/align=alt_agqmaster:off_premises_limit
agqgeneral:restaurant_enhancement/mask="ZZ,ZZZ.99-"/align=alt_agqmaster:off_premises_premium/newline=2
...
if agqepl:third_party = 1 then
    ...
    agqepl:third_party_premium/mask="ZZ,ZZZ.99-"/align=agqgeneral:off_premises_premium
    if agqepl:epl_limit < 500000 then
        box/noblanklines/noheading/column=1
        "EPL Percent:"/column=46
        agqepl:epl_percent/mask="ZZ.ZZ%"/align=agqgeneral:mechanical_limit
        end box
    end box/newline
else
if agqepl:epl_limit < 500000 then
...
trun(alt_agqend1:form_edition) + " " + alt_agqend1:description[1,50]/column=20/duplicates
alt_agqend1:premium/mask="ZZ,ZZZ.99-"/duplicates/column=90
end box
...
if alt_agqend:form_edition = "" then
    trun(alt_agqend:code) + " " + alt_agqend:description[1,50]
else
    trun(alt_agqend:form_edition) + " " + alt_agqend:description[1,50]/column=20/duplicates
alt_agqend:premium/mask="ZZ,ZZZ.99-"/duplicates/column=90
end box/newlines=2
...
"FOB:        "/COLUMN=1
alt_sfsfob:description/column=25/newline
...
alt_agqmaster:total[1] + alt_agqmaster:total[2]/column=30/mask="$$,$$$,$$$.99"/newline
...
"      Total Premium:"/column=10
alt_agqmaster:total[20] - alt_agqmaster:surcharge/newline/mask="$$,$$$,$$$.99"/column=30
...
alt_agqmaster:total[20]/column=30/mask="$$,$$$,$$$.99"/newline=2
